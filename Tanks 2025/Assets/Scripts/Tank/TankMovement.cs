...
namespace Tanks.Complete
{
    ...
    public class TankMovement : MonoBehaviour
    {
        ...
        private void OnEnable ()
        {
            ...
            // it "thinks" it moves from (0,0,0) to the spawn point, creating a huge trail of smoke
            m_particleSystems = GetComponentsInChildren<ParticleSystem>();
            foreach (var t in m_particleSystems)
            {
                t.Play();
            }
        }
        ...
        private void Start ()
        {
            ...
            if (m_IsComputerControlled)
            {
                ...
                if (ai == null)
                {
                    ...
                    // computer controlled tank are set up properly
        ...
        private void FixedUpdate ()
        {
            ...
            if (m_InputUser.InputUser.controlScheme != null && (m_InputUser.InputUser.controlScheme.Value.name == "Gamepad" ||  m_IsDirectControl))
            {
                if (Camera.main != null)
                {
